...
def createUserData():
    start_date = request.form['date_of_last_period']
    avg_period = request.form['avg_period_length']
    avg_cycle = request.form['avg_cycle_length']
    new_user_data = UserData(start_date, avg_period, avg_cycle)
    db.session.add(new_user_data)
    db.session.commit()
    return "<p>User data has been added</p>"
